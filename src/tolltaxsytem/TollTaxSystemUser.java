 ...
 * @author Arush
 */
public class TollTaxSystemUser extends javax.swing.JFrame {

    /**
     * Creates new form MainMenu
     */
    public TollTaxSystemUser() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jButton2.setText("Recharge Balance");
...
else
{
    ...
    JOptionPane.showMessageDialog(null,"Your account is not registered. Please get you account registered by Database Administrator");
    this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TollTaxSystemUser.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
