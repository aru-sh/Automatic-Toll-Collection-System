 ...
 * @author Arush
 */
public class RechargeAccount extends javax.swing.JFrame {
...
new Settings().setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RechargeAccount.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
